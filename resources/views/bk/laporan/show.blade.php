...
@section('content')
    ...
    @if(session('success'))
        <div class="mb-5 bg-green-50 border border-green-200 text-green-700 px-5 py-4 rounded-2xl text-sm">
            {{ session('success') }}
        </div>
    @endif
...
=======
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm divide-y divide-slate-100">
        ...
        {{-- DATA SISWA + DETAIL LAPORAN (VERIFIKASI MENYATU DI SINI) --}}
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
        ...
        {{-- JADWAL PEMANGGILAN --}}
        @if($laporan->status === 'pemanggilan' && $laporan->pemanggilan->isEmpty())
            <div class="p-6">
                <div class="flex items-center gap-2 mb-5 pb-4 border-b border-slate-100">
                    <i data-feather="phone" class="w-4 h-4 text-blue-600"></i>
                    <h2 class="text-sm font-bold text-slate-700">Jadwalkan Pemanggilan</h2>
                </div>
    ...
    @if($laporan->status === 'baru')
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 mb-5">
            <div class="flex items-center gap-2 mb-5 pb-4 border-b border-slate-100">
                ...
                <h2 class="text-sm font-bold text-slate-700">Verifikasi Laporan</h2>
            </div>
            ...
            <form action="{{ route('bk.laporan.update', $laporan->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-slate-600 mb-1.5">Jenis Masalah</label>
                        <input type="text" name="jenis_masalah" required
                            value="{{ old('jenis_masalah', $laporan->jenis_masalah) }}"
                            placeholder="Contoh: Bolos, bertengkar, perundungan"
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
            ...
            <form action="{{ route('bk.pemanggilan.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="tanggal_pemanggilan" required
                            value="{{ old('tanggal_pemanggilan') }}"
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="time" name="waktu_pemanggilan" required
                            value="{{ old('waktu_pemanggilan') }}"
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="pihak_dipanggil" required
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
                            <option value="siswa">Siswa</option>
                            <option value="orang_tua">Orang Tua / Wali</option>
                            <option value="siswa_orang_tua">Siswa dan Orang Tua / Wali</option>
