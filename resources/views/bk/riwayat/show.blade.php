...
<div class="mb-6 flex items-center gap-3">
    ...
    <span class="text-sm text-slate-800 font-semibold">Detail Riwayat Permasalahan</span>
    ...
    <div class="ml-auto flex items-center gap-2">
        ...
        <a href="{{ route('bk.download.kasus', $laporan->id) }}"
            class="inline-flex items-center gap-2 px-4 py-2 bg-blue-700 text-white rounded-xl text-sm font-semibold hover:bg-blue-800 transition-colors">
            <i data-feather="download" class="w-4 h-4"></i>
            Download Permasalahan
        </a>
    </div>
</div>
