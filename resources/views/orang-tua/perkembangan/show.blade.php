    ...
    <div class="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <section class="p-4 sm:p-6 border-b border-slate-200">
            <div class="flex items-center gap-2 mb-4 sm:mb-5">
                ...
                <h2 class="text-base font-extrabold text-slate-900">Data Anak</h2>
            </div>
        ...
        ? route('foto.siswa', $laporan->siswa->nis)
        : asset('asset/default-user.png') }}"
                ...
                {{-- DATA --}}
                <div class="flex-1">
                    <div class="grid grid-cols-2 gap-x-4 gap-y-4 sm:gap-x-8 sm:gap-y-5">
                        @foreach([
        ...
        <section class="p-4 sm:p-6 border-b border-slate-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                <div>
                    <p class="text-xs font-bold text-slate-400 uppercase">Judul</p>
                ...
                <div>
                    ...
                    <p class="text-sm font-semibold text-slate-800 mt-1">
                        {{ $laporan->kategori ? ucfirst($laporan->kategori) : '-' }}
                    </p>
                </div>
            ...
            @if($monitoringTerjadwal)
                <div
                    class="bg-blue-50 border border-blue-200 rounded-2xl px-4 py-3.5 sm:px-5 sm:py-4 mt-5 flex items-start sm:items-center gap-3 sm:gap-4">
        ...
        <section class="p-4 sm:p-6">
            <div class="flex items-center gap-2 mb-4">
                ...
                <h2 class="text-base font-extrabold text-slate-900">Evaluasi Guru BK</h2>
            </div>
